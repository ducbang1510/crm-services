...
public class MessageConstants {
    ...
    public static final String STARTING_PASSPORT_AUTHEN = "Starting passport authentication...";
    public static final String PASSPORT_MIDDLEWARE_ERROR = "Error from passport middleware.";
    public static final String REGISTER_USER_SUCCESS = "User is registered succesfully!";
    public static final String AUTHENTICATION_FAILED = "Unknown user or wrong password!";
    public static final String FETCHING_USER_INFO = "Fetching user information...";
    public static final String FETCHING_USER_INFO_SUCCESS = "Fetching user information sucessfully!";
    ...
    public static final String FETCHING_LIST_OF_USERS = "Fetching list of users...";
    ...
    public static final String FETCHING_LIST_OF_NAMES_USERS = "Fetching list of names of users...";
    ...
    public static final String UPDATING_USER = "Updating user information...";
    ...
    public static final String CHANGING_USER_PASSWORD = "Changing user password...";
    ...
    public static final String CREATING_NEW_SALES_ORDER = "Creating new sales order...";
    ...
    public static final String FETCHING_LIST_OF_SALES_ORDER = "Fetching list of sales order...";
    ...
    public static final String FETCHING_SALES_ORDER = "Fetching sales order...";
    ...
    public static final String UPDATING_SALES_ORDER = "Updating sales order...";
    ...
    public static final String DELETING_SALES_ORDER = "Deleting sales order...";
    ...
    public static final String DELETING_LIST_OF_SALES_ORDERS = "Deleting list of sales orders...";
    ...
    public static final String FINDING_SALES_ORDER = "Finding sales order...";
    ...
    public static final String COUNTING_NO_SALES_ORDERS_BY_STATUS = "Counting number of sales order based on Status...";
    ...
    public static final String CREATING_NEW_CONTACT = "Creating new contact...";
    ...
    public static final String FETCHING_LIST_OF_CONTACTS = "Fetching list of contacts...";
    ...
    public static final String FETCHING_LIST_OF_CONTACT_NAMES = "Fetching list of contact names...";
    ...
    public static final String FETCHING_CONTACT = "Fetching contact...";
    ...
    public static final String UPDATING_CONTACT = "Updating contact...";
    public static final String UPDATING_CONTACT_SUCCESS = "Updating contact successfully!";
    public static final String UPDATING_CONTACT_ERROR = "Error while updating contact:";
    ...
    public static final String DELETING_LIST_OF_CONTACTS = "Deleting list of contacts...";
    ...
    public static final String FINDING_CONTACT = "Finding contacts...";
    ...
    public static final String COUNTING_NO_CONTACTS_BY_LEAD_SRC = "Counting number of contacts based on Lead source...";
